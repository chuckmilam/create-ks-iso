...
NOTICE: This system was provisioned with kickstart generated by $0 at $(date).
NOTICE: Unless specified at the time of kickstart generation, user credentials, including passwords and SSH keys, have been randomly generated.

WARNING: This system is in a minimal configuration state. Further system configuration and hardening is required.
