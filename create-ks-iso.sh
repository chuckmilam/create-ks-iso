...
NOTE:
This system was provisioned with kickstart generated by $0 at $(date).

User credentials including passwords and SSH keys were randomly-generated,
unless they were specified at the time of kickstart generation.

Edit /etc/issue to remove this message.
